...
export const GestionFlota = (): JSX.Element => {
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      {/* Hero Section */}
      <Section className="relative h-[70vh] flex items-center justify-center bg-[url(https://images.pexels.com/photos/7348711/pexels-photo-7348711.jpeg)] bg-cover bg-center bg-fixed">
        ...
        <div className="relative text-center text-white space-y-6 max-w-4xl mx-auto px-4">
          ...
          >
            Control y seguimiento en tiempo real para tu flota
          </motion.p>
        </div>
      </Section>
      ...
      <Section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Control total de tu flota</p>
        </div>
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <img
              ...
              alt="Sistema de Gestión de Flota"
      ...
      <Section className="py-24 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Solución integral de gestión de flota</p>
          </div>
